...
test("throws an error when we can't find file-loader in the webpack config", () => {
  ...
  expect(runTest).toThrowError(
    "Can't find file-loader in the webpack config!\n\n" +
      ...
      "Please try updating craco-raw-loader to the latest version:\n\n" +
      "   $ yarn upgrade craco-raw-loader\n\n" +
      "Or:\n\n" +
      "   $ npm update craco-raw-loader\n\n" +
      "If that doesn't work, craco-raw-loader needs to be fixed to support the latest version.\n" +
